...
# =========================
# 3. Data augmentation block
# =========================

# These layers are active only during training.
# They randomly modify training images to reduce overfitting.
...
checkpoint_path = os.path.join(MODELS_DIR, "augmented_cnn_best.keras")
...
figure_path = os.path.join(FIGURES_DIR, "augmented_cnn_learning_curves.png")
...
final_model_path = os.path.join(MODELS_DIR, "augmented_cnn_final.keras")
...
# =========================
# 11. Save results in a text file
# =========================

results_path = os.path.join(RESULT_DIR, "augmented_cnn_results.txt")

with open(results_path, "w") as f:
    f.write("Augmented CNN Results\n")
    f.write("=====================\n\n")
...
print("\nAugmented CNN training completed successfully.")